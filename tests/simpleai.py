...
class SimpleAIPlayer():
    ...
    def ponder_finish(self, game, me):
        ...
        if me.cur_role == 8:
            ...
            if (potential_target and
                ...
                return {"name": "use_power", "target_player_id": victim.position,
                        "target_card_id": potential_target['id']}
    ...
    def ponder_pick_role(self, game, me):
        ...
        logging.info(
            "%s is picking a role, and game.round.role_draw_pile is : %s" % (me.name, game.round.role_draw_pile))
